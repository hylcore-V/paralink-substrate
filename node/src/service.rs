...
use paralink_runtime::{self, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	paralink_runtime::api::dispatch,
	paralink_runtime::native_version,
...
>, ServiceError> {
	...
	// keystore_container.write().insert_ephemeral_from_seed_by_type::<paralink_runtime::pallet_ocw::crypto::Pair>(
